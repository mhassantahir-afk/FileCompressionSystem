...
int main() {
    ...
    lz.compress("../resources/TestFiles/yourfile.txt", "../resources/TestFiles/compressed.lz77");
    cout << "File compressed successfully!" << endl << endl;

    // Test decompression
    cout << "Decompressing file..." << endl;
    lz.decompress("../resources/TestFiles/compressed.lz77", "../resources/TestFiles/restored.txt");
